...
//the name is the version, to keep compatibility with different versions of Active
...
bool EditorFileSystem::_should_skip_directory(const String &p_path) {
	...
	if (FileAccess::exists(p_path.plus_file("project.active"))) { // skip if another project inside this
		return true;
	}
