...
EditorAbout::EditorAbout() {
	set_title(TTR("Thanks from the Active community!"));
	set_hide_on_ok(true);
	set_resizable(true);
	...
	about_text->set_text(
			String::utf8("\xc2\xa9 2014-present ") + TTR("Active Engine contributors") + "." +
	...
	_license_text->set_text(String::utf8(ACTIVE_LICENSE_TEXT));
	...
	tpl_label->set_text(TTR("Active Engine relies on a number of third-party free and open source libraries, all compatible with the terms of its MIT license. The following is an exhaustive list of all such third-party components with their respective copyright statements and license terms."));
