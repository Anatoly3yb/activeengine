...
- [Contributing to Active's translation](#contributing-to-actives-translation)
...
**search first in the [issue tracker](https://github.com/activeengine/active/issues)
...
Active runs on a large variety of platforms and operating systems and devices.
**In your bug reports, please always specify:**

- Operating system and version (e.g. Windows 10, macOS 10.15, Ubuntu 19.10)
- Active version (e.g. 3.2, 3.1.2, or the Git commit hash if you're using a development branch)
...
- **[Report a bug](https://github.com/activeengine/active/issues/new?assignees=&labels=&template=bug_report.yml)**

## Proposing features or improvements

**Since August 2019, the main issue tracker no longer accepts feature proposals.**
Instead, head to the [Active Proposals repository](https://github.com/activeengine/active-proposals)
...
See [this article](https://activeengine.org/article/introducing-active-proposals-repository)
...
[This blog post](https://activeengine.org/article/will-your-contribution-be-merged-heres-how-tell)
...
[Engine development guide](https://docs.activeengine.org/en/latest/development/cpp/)
for an introduction to developing on Active.

The [Contributing docs](https://docs.activeengine.org/en/latest/community/contributing/index.html)
...
[Update the documentation template](https://docs.activeengine.org/en/latest/community/contributing/updating_the_class_reference.html#updating-the-documentation-template)
using your compiled binary, then fill in the descriptions.
Follow the style guide described in the
[Docs writing guidelines](https://docs.activeengine.org/en/latest/community/contributing/docs_writing_guidelines.html).
...
See our [PR workflow](https://docs.activeengine.org/en/latest/community/contributing/pr_workflow.html)
...
When using the French fries frying module, Active would not regulate the heat
and thus bring the oil bath to supercritical liquid conditions, thus causing
unwanted side effects in the physics engine.

By fixing the regulation system via an added binding to the internal feature,
this commit now ensures that Active will not go past the ebullition temperature
...
## Contributing to Active's translation

You can contribute to Active's translation from the [Hosted
Weblate](https://hosted.weblate.org/projects/active-engine/active), an open
...
You can also help translate [Active's
documentation](https://hosted.weblate.org/projects/active-engine/active-docs/)
on Weblate.

## Communicating with developers

The Active Engine community has [many communication
channels](https://activeengine.org/community), some used more for user-level
discussions and support, others more for development discussions.

To communicate with developers (e.g. to discuss a feature you want to implement
or a bug you want to fix), the following channels can be used:

- [Active Contributors Chat](https://chat.activeengine.org): You will
  find most core developers there, so it's the go-to platform for direct chat
  about Active Engine development. Feel free to start discussing something there
  to get some early feedback before writing up a detailed proposal in a GitHub
  issue.
- [Bug tracker](https://github.com/activeengine/active/issues): If there is an
...
- [Feature proposals](https://github.com/activeengine/active-proposals/issues):
  To propose a new feature, we have a dedicated issue tracker for that. Don't
  hesitate to start by talking about your idea on the Active Contributors Chat
  to make sure that it makes sense in Active's context.

Thanks for your interest in contributing!

—The Active development team
