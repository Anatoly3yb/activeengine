# Git hooks for Active Engine

This folder contains Git hooks meant to be installed locally by Active Engine
...
matches `pre-commit-custom-*`, after the Active ones.
