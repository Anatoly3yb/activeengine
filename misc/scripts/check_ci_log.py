...
if (
    ...
    print("FATAL ERROR: Active has been crashed.")
    sys.exit(1)

# Finding memory leaks in Active is quite difficult, because we need to take into
...
# It may happen that Active detects leaking nodes/resources and removes them, so
