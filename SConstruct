...
opts.Add(BoolVariable("tools", "Build the tools (a.k.a. the Active editor)", True))
opts.Add(EnumVariable("target", "Compilation target", "debug", ("debug", "release_debug", "release")))
opts.Add("arch", "Platform-dependent architecture (arm/arm64/x86/x64/mips/...)", "")
opts.Add(EnumVariable("bits", "Target platform bits", "default", ("default", "32", "64")))
opts.Add(EnumVariable("optimize", "Optimization type", "speed", ("speed", "size", "none")))
opts.Add(BoolVariable("production", "Set defaults to build Active for use in production", False))
...
if selected_platform == "macos":
    ...
    print('Platform "macos" is still called "osx" in Active 3.x. Building for platform "osx".')
    selected_platform = "osx"

if selected_platform == "ios":
    # Alias for forward compatibility.
    print('Platform "ios" is still called "iphone" in Active 3.x. Building for platform "iphone".')
    selected_platform = "iphone"

if selected_platform in ["linux", "bsd", "linuxbsd"]:
    if selected_platform == "linuxbsd":
        # Alias for forward compatibility.
        print('Platform "linuxbsd" is still called "x11" in Active 3.x. Building for platform "x11".')
    # Alias for convenience.
    selected_platform = "x11"

if selected_platform == "web":
    # Alias for forward compatibility.
    print('Platform "web" is still called "javascript" in Active 3.x. Building for platform "javascript".')
...
if selected_platform in platform_list:
    ...
    # Disable exception handling. Active doesn't use exceptions anywhere, and this
