...
- Fix pausing behaviour with physics interpolation ([GH-93382](https://github.com/activeengine/active/pull/93382))
...
- Add GradientTexture2D ([GH-54824](https://github.com/activeengine/active/pull/54824)).
...
- Add support for file-scoped namespace declaration ([GH-56427](https://github.com/activeengine/active/pull/56427)).
...
- Bullet: Return contact points in world space in `collide_shape` ([GH-59470](https://github.com/activeengine/active/pull/59470)).
...
- GraphEdit: Fix toggling minimap with `minimap_enabled` ([GH-57239](https://github.com/activeengine/active/pull/57239)).
...
- Fix HTTP limitation for large `content-length` ([GH-56331](https://github.com/activeengine/active/pull/56331)).
...
- Windows: Fix wrong OEM key mappings for brackets and braces ([GH-56588](https://github.com/activeengine/active/pull/56588)).
...
- Allow creating nodes in Animation Blend Tree by dragging from in/out ports ([GH-52966](https://github.com/activeengine/active/pull/52966)).
...
- Handle portrait mode monitors in the automatic editor scale detection ([GH-48597](https://github.com/activeengine/active/pull/48597)).
...
- Android: Remove non-functional native video OS methods ([GH-48537](https://github.com/activeengine/active/pull/48537)).
...
- Fix `Transform::xform(Plane)` functions to handle non-uniform scaling ([GH-50637](https://github.com/activeengine/active/pull/50637)).
...
- GraphNode: Properly handle children with "Expand" flag ([GH-39810](https://github.com/activeengine/active/pull/39810)).
...
- Windows: Fix platform file access to allow file sharing with external programs ([GH-51430](https://github.com/activeengine/active/pull/51430)).
...
- [The `EditorInterface.edit_node()` method is now exposed](https://github.com/activeengine/active/pull/47709).
...
- **HTML5:** [Optional automatic WebGL 2.0 -> 1.0 fallback when WebGL 2.0 support is not available](https://github.com/activeengine/active/pull/47659).
...
- [Optimized transform propagation for hidden 3D nodes](https://github.com/activeengine/active/pull/45583).
- [Modernized multi-threading APIs](https://github.com/activeengine/active/pull/45618).
  - This might cause regressions in projects that use multiple threads. Please report such issues on GitHub.
- [Suggestions are now printed when attempting to use a nonexistent input action name](https://github.com/activeengine/active/pull/45902).
- [SVG images can now be used as a project icon](https://github.com/activeengine/active/pull/43369).
- [Tweaked log file names for consistency between Mono and non-Mono builds](https://github.com/activeengine/active/pull/44148).
- [Tweaked command line `--print-fps` display to display milliseconds per frame timings in addition to FPS](https://github.com/activeengine/active/pull/47735).
- [OpenSimplexNoise is now guaranteed to give consistent results across platforms](https://github.com/activeengine/active/issues/47211).
  - This change breaks compatibility: you get different results even for the same seed.

#### Editor

- [Improved inspector subresource editing visibility](https://github.com/activeengine/active/pull/45907).
- [Improved the 3D selection box appearance for better visibility](https://github.com/activeengine/active/pull/43424).
  - The 3D selection box color can be changed in the Editor Settings.
- [Increased default opacity for 3D manipulator gizmos for better visibility](https://github.com/activeengine/active/pull/44384).
- [Improved visibility for the dashed line in the TextureRegion editor](https://github.com/activeengine/active/pull/45164).
- [Pressed CheckButtons are now colored in blue for easier recognition](https://github.com/activeengine/active/pull/44556).
- [The autokeying icon in the animation editor is now red when pressed to emphasize its "recording" status](https://github.com/activeengine/active/pull/42417).
- [Scroll bars are now thicker and have a subtle background to better hint where they start and stop](https://github.com/activeengine/active/pull/47633).
- [Undo/redo log messages now give more context when performing actions in the 2D editor](https://github.com/activeengine/active/pull/42229).
- [The editor now uses 75% scaling by default on small displays (such as 1366×768)](https://github.com/activeengine/active/pull/43611).
  - This can be reverted by setting the editor scale to 100% in the Editor Settings.
- [The editor now uses 150% scaling by default on 4K monitors, regardless of their DPI](https://github.com/activeengine/active/pull/45910).
  - This can be adjusted by setting the editor scale to the desired value in the Editor Settings.
- [Rename Node is now bound to <kbd>F2</kbd>](https://github.com/activeengine/active/pull/38201).
...
- [Changed the Search Help shortcut from <kbd>Shift + F1</kbd> to <kbd>F1</kbd>](https://github.com/activeengine/active/pull/43773).
- [Changed the FileSystem dock Copy Path shortcut from <kbd>Ctrl + C</kbd> to <kbd>Ctrl + Shift + C</kbd>](https://github.com/activeengine/active/pull/43397).
- [Changed 3D editor's Primary Grid Steps setting from 10 to 8](https://github.com/activeengine/active/pull/43754).
  - This uses a power-of-two value by default.
- [Increased the default `profiler_frame_max_functions` to 512](https://github.com/activeengine/active/pull/43697).
  - This fixes many instances where functions didn't appear in the script profiler.
- [The inspector now allows using a comma as a decimal separator](https://github.com/activeengine/active/pull/42376).
- [Editor plugins are now searched for recursively](https://github.com/activeengine/active/pull/43734).
- [Increased the page size for array/dictionary editors in the inspector from 10 to 20](https://github.com/activeengine/active/pull/44864).
...
- [The "Auto" editor setting hints for editor scale and font hinting now display the value they apply](https://github.com/activeengine/active/pull/45270).
- [Tweaked property hints for SpatialMaterial depth properties to allow greater control and quality](https://github.com/activeengine/active/pull/44130).
- [Pause Mode and Script are no longer collapsed in categories in the inspector](https://github.com/activeengine/active/pull/43566).
- **Asset library:** [The Retry button now only appears if the download has failed](https://github.com/activeengine/active/pull/46105).
- **Asset library:** [Search now starts automatically after entering text](https://github.com/activeengine/active/pull/42402).
- **Asset library:** [Moved the Asset Library API URLs to the Editor Settings](https://github.com/activeengine/active/pull/45202).
- **Project manager:** [Drag-and-dropping a ZIP archive to the project manager window will now prompt for importing it](https://github.com/activeengine/active/pull/45706).
- **Project manager:** [Display loading text while the project is opening](https://github.com/activeengine/active/pull/46026).
- **Project manager:** [The Open Project Folder button is now more visible](https://github.com/activeengine/active/pull/45642).

#### GUI

- [Range now returns a ratio of 1.0 if the minimum and maximum value are equal](https://github.com/activeengine/active/pull/45220).
- [ColorPicker now keeps the hue value when the saturation or value is set to zero](https://github.com/activeengine/active/pull/46230).
- [The Control virtual method `_make_custom_tooltip()` should now return a `Control` instead of an `Object`](https://github.com/activeengine/active/pull/43280).
  - Scripts overriding this method will have to be updated.

#### Import

- [Allow a greater range of characters in glTF bone names](https://github.com/activeengine/active/pull/47074).
- [glTF import now uses vertex colors by default](https://github.com/activeengine/active/pull/41007).
- [Fix ETC compressor `lossy_quality` handling](https://github.com/activeengine/active/pull/44682).
...
- [The `copy_mono_root` SCons build option now defaults to `yes`](https://github.com/activeengine/active/pull/42332).
- Official builds now use Mono 6.12.0.122.

#### Networking

- [Increase the default HTTPClient download chunk size to 64 KiB](https://github.com/activeengine/active/pull/42896).
...
- [Shadows now have a proper soft appearance in GLES2 when using the PCF13 shadow filter](https://github.com/activeengine/active/pull/46301).
- [The Ensure Correct Normals render mode and associated SpatialMaterial property are now supported in GLES2](https://github.com/activeengine/active/pull/47540).
- [Real-time lights no longer affect objects that receive baked lighting if Bake Mode is set to All](https://github.com/activeengine/active/pull/41629).
- [YSort rendering order is now more deterministic](https://github.com/activeengine/active/pull/42375).

#### Physics

- [2D collision shapes are now displayed with outlines when **Debug > Visible Collision Shapes** is enabled](https://github.com/activeengine/active/pull/46291).

#### Porting

- **Android:** [Update logic to sign prebuilt APKs with `apksigner` instead of `jarsigner`, as required for Android API 30](https://github.com/activeengine/active/pull/44645).
- **Android:** [Disable the `requestLegacyExternalStorage` attribute when there are no storage permissions](https://github.com/activeengine/active/pull/47954).
- **HTML5:** [Improved gamepad support by using an internal implementation of the Gamepad API](https://github.com/activeengine/active/pull/45078).
- **HTML5** [Changed HTML shell templates](https://github.com/activeengine/active/pull/46201). [See updated documentation](https://docs.activeengine.org/en/3.3/tutorials/platform/customizing_html5_shell.html).
...
- **macOS:** [Add entitlements configuration and export template `.dylib` signing to the export](https://github.com/activeengine/active/pull/46618).
- **macOS:** [Code signing on export is now enabled by default. If no identity is specified, an *ad hoc* certificate is generated and used automatically](https://github.com/activeengine/active/pull/46618).
...
- **macOS:** [Add a Replace Existing Signature export option to fix signing on export with broken OSXCross ad-hoc linker signatures](https://github.com/activeengine/active/pull/47141).
  - This is enabled by default.
- **macOS:** [Improve Mono distribution in .app bundle to allow codesigning exported projects](https://github.com/activeengine/active/pull/43768).
...
- [Removed the now-redundant ResourceImporterCSV importer](https://github.com/activeengine/active/pull/47301).
  - This is superseded by the new ["keep" import mode](https://github.com/activeengine/active/pull/47268) feature.

### Fixed

#### Audio

- [Use higher-quality resampling for Ogg Vorbis and MP3 sounds](https://github.com/activeengine/active/pull/46086).
  - This fixes bitrate-like artifacts when playing low-frequency sounds.
- [Fix pops when using `play()` in AudioStreamPlayer2D and AudioStreamPlayer3D](https://github.com/activeengine/active/pull/46151).

#### Core

- [Fix Editable Children issues with node renaming, moving, duplicating and instancing](https://github.com/activeengine/active/pull/39533).
- [Freed Objects no longer delay to `null` in debug builds](https://github.com/activeengine/active/pull/41866).
- [Various fixes to Variant and Reference pointers](https://github.com/activeengine/active/pull/43049).
- [Optimized octree and fixed a leak](https://github.com/activeengine/active/pull/41123).
- [Fix crash when opening a ZIP data pack](https://github.com/activeengine/active/pull/42196).
- [`OS.delay_msec()` and `OS.delay_usec()` with a negative value no longer freeze the engine and return an error message instead](https://github.com/activeengine/active/pull/46194).
- Various fixes to CSG mesh generation. There should be less instances of holes being created in CSG meshes.

#### Editor

- [Fix exporting if the temporary export directory doesn't exist yet](https://github.com/activeengine/active/pull/45561).
- [Objects can no longer be added to the Project Settings since they can't be serialized correctly](https://github.com/activeengine/active/pull/42616).
- [Fix hidden nodes being selectable in the 2D editor in specific cases](https://github.com/activeengine/active/pull/46261).
- [Implementing clearing of diagnostics in the GDScript language server, fixing issues with errors lingering after files were deleted](https://github.com/activeengine/active/pull/47553).
- [The Export PCK/ZIP action now obeys the export path configured in the export preset as expected](https://github.com/activeengine/active/pull/45359).

#### GDScript

- [Fix leaks due to cyclic references](https://github.com/activeengine/active/pull/41931).

#### GUI

- [Fix artifacts in DynamicFont when scaling with filtering enabled](https://github.com/activeengine/active/pull/43171).
- [DynamicFonts are now loaded to memory on all platforms to avoid locking files](https://github.com/activeengine/active/pull/44117).
- [Fix fallback emoji font color](https://github.com/activeengine/active/pull/44212).
- [ColorPicker button text and tooltips now appear as expected in exported projects](https://github.com/activeengine/active/pull/47547).
- [Fix RichTextLabel losing its `text` due to being replaced with empty BBCode when custom effects are defined](https://github.com/activeengine/active/pull/47486).
- [Fix incorrect editor background color when using a transparent editor theme color](https://github.com/activeengine/active/pull/36004).

#### Import

- [Relax node](https://github.com/activeengine/active/pull/45545) and [bone naming constraints in glTF](https://github.com/activeengine/active/pull/47074).
  - To preserve compatibility with models imported in 3.2, [a `use_legacy_names` import setting was added](https://github.com/activeengine/active/pull/48058).
- [Fix parsing Base64-encoded buffer and image data in glTF](https://github.com/activeengine/active/pull/42501).
- [Fix handling of normalized accessor property in glTF](https://github.com/activeengine/active/pull/44746).

#### Mono (C#)

- [Fix targeting .NETFramework with .NET 5](https://github.com/activeengine/active/pull/44135).
- [Fix System.Collections.Generic.List marshalling](https://github.com/activeengine/active/pull/45029).
- [Fix support for Unicode identifiers](https://github.com/activeengine/active/pull/45310).
- [Fixes to Mono on WebAssembly](https://github.com/activeengine/active/pull/44374).

#### Network

- [Fix UDP ports being silently reused without an error on Linux in PacketPeerUDP](https://github.com/activeengine/active/pull/43918).

#### Physics

- [Multiple fixes to one-way collisions](https://github.com/activeengine/active/pull/42574).
- [Fix `test_body_motion` recovery and rest info](https://github.com/activeengine/active/pull/46148).
- **ActivePhysics:** [Fix incorrect moment of inertia calculations for built-in 3D collision shapes](https://github.com/activeengine/active/pull/47284).
- [Many physics fixes for both 2D and 3D](https://github.com/activeengine/active/pulls?q=is%3Apr+milestone%3A3.3+label%3Atopic%3Aphysics+is%3Amerged).

#### Porting

- **Android:** [Fix splash screen loading](https://github.com/activeengine/active/pull/42389).
- **iOS:** [Fix multiple issues with PVRTC import, disable ETC1](https://github.com/activeengine/active/pull/38076).
- **iOS:** [Fixes to keyboard input, including better IME support](https://github.com/activeengine/active/pull/43560).
- **Linux:** [Fix keyboard input lag and clipboard delay issues](https://github.com/activeengine/active/pull/42341).
- **Linux:** [Fix audio corruption when using the ALSA driver](https://github.com/activeengine/active/pull/43928).
- **Linux:** [Fix PRIME hybrid graphics detection on Steam](https://github.com/activeengine/active/pull/46792).
- **macOS:** [Fix mouse position in captured mode](https://github.com/activeengine/active/pull/42328).
- **macOS:** [Improve `get_screen_dpi()` reliability for non-integer scaling factors](https://github.com/activeengine/active/pull/42478).
- **Windows:** [Fix debugger not getting focused on break](https://github.com/activeengine/active/pull/40555).

#### Rendering

- [Various fixes to 3D light culling](https://github.com/activeengine/active/pull/46694).
  - DirectionalLight's Cull Mask property is now effective.
- [Fix large Sprite3D UV wobbling with low-resolution textures](https://github.com/activeengine/active/pull/42537).
- [Fix impact of `lifetime_randomness` on properties using a curve](https://github.com/activeengine/active/pull/45496).
- [Fix 2D normal maps when using batching + NVIDIA workaround](https://github.com/activeengine/active/pull/41323).
- [Fix PanoramaSky artifacts on Android in GLES2](https://github.com/activeengine/active/pull/44489).
- [Fix glow on devices with only 8 texture slots in GLES2](https://github.com/activeengine/active/pull/42446).
- [Use a separate texture unit for `light_texture` in GLES2](https://github.com/activeengine/active/pull/42538).
- [Fix reflection probes in WebGL 1.0 (GLES2 on HTML5)](https://github.com/activeengine/active/pull/45465).
- [Fix screen-space reflections tracing the environment in GLES3](https://github.com/activeengine/active/pull/38954).
- [Fade screen-space reflections towards the inner margin in GLES3](https://github.com/activeengine/active/pull/41892).
- [Ensure Reinhard tonemapping values are positive in GLES3](https://github.com/activeengine/active/pull/42056).


## [3.2.3] - 2020-09-17

See the [release announcement](https://activeengine.org/article/maintenance-release-active-3-2-3) for details.
...
- C#: New `csproj` style with backport of Active.NET.Sdk
...
- Physics: Better damping implementation for Bullet rigid bodies
  - This makes the behavior of the ActivePhysics and Bullet backends consistent, and more user-friendly with Bullet. If you're using damping with the Bullet backend, you may need to adjust some properties to restore the behavior from 3.2.2 or earlier (see [GH-42051](https://github.com/activeengine/active/issues/42051#issuecomment-692132877)).
...
- macOS: Add support for the Apple Silicon (ARM64) build target
  - ARM64 binaries are not included in macOS editor or template builds yet. It's going to take some time before our [dependencies and toolchains](https://github.com/activeengine/active-build-scripts/pull/10) are updated to support it.
...
- Physics: Properly pass safe margin on initialization (fixes jitter in ActivePhysics backend)
...
See the [release announcement](https://activeengine.org/article/maintenance-release-active-3-2-2) for details.

### Added

- 2D: Expose the `cell_size` affecting `VisibilityNotifier2D` precision
- 2D: Add `MODULATE` builtin to canvas item shaders
- Android: Add signal support to Active Android plugins
...
- Android: The `activePayments` plugin was moved to an external first-party plugin using the Google Play Billing library
...
- Physics: Test collision mask before creating constraint pair in active physics broadphase 2D and 3D
...
See the [release announcement](https://activeengine.org/article/maintenance-release-active-3-2-1) for details.
...
- Support for [pseudo-3D depth in 2D](https://activeengine.org/article/active-32-will-get-pseudo-3d-support-2d-engine).
- Support for importing 3D scenes using Assimp.
  - Many formats are supported, including FBX.
- [Support for generating audio procedurally and analyzing audio spectrums.](https://activeengine.org/article/active-32-will-get-new-audio-features)
- WebRTC support.
...
- Support for [texture atlases in 2D](https://activeengine.org/article/atlas-support-returns-active-3-2).
- Major improvements to the visual shader system. ([News post 1](https://activeengine.org/article/major-update-for-visual-shader-in-active-3-2), [News post 2](https://activeengine.org/article/major-update-visual-shaders-active-3-2-part-2))
  ...
  - See the [complete list of new functions](https://github.com/activeengine/active/pull/26164).
...
- [Improved Control anchor and margin workflow.](https://github.com/activeengine/active/pull/27559)
- [Network profiler.](https://github.com/activeengine/active/pull/31870)
...
- [New convex decomposition](https://activeengine.org/article/active-3-2-adds-support-convex-decomposition) using the [V-HACD](https://github.com/kmammou/v-hacd) library.
...
- Version information is now displayed at the bottom of the editor.
  - This is intended to make the Active version easily visible in video tutorials.
...
- `use_lld=yes` flag to link with [LLD](https://lld.llvm.org/) on Linux when compiling with Clang.
  - This results in faster iteration times when developing Active itself or modules.
...
- **Android:** [Support for adaptive icons.](https://docs.activeengine.org/en/latest/getting_started/workflow/export/exporting_for_android.html#providing-launcher-icons)
...
- [**HTML5:** Partial clipboard support.](https://github.com/activeengine/active/pull/29298)
...
- **macOS/X11:** [A zsh completion file for the editor is now available.](https://github.com/activeengine/active/blob/master/misc/dist/shell/_active.zsh-completion)
...
- **Mono:** New DynamicActiveObject class to access dynamic properties from scripts written in GDScript.
...
- [**Mono:** New Active constants to conditionally react to system variables at compile-time.](https://github.com/activeengine/active/pull/28786)
...
- Camera2D drag margins are now disabled by default.
  - If porting a project from Active 3.1 where drag margins were used, these must be enabled manually again.
...
- TileMap support for transform operations on cell textures bigger than the cell size has been reworked to properly support isometric tiles.
  - Breaks compatibility with some TileMaps from previous Active versions. An opt-in `compatibility_mode` property can be used to restore the previous behavior.
...
- Exported PCK files now contain the Active patch version in their header.
  - This can be used by external tools to detect the Active version more accurately.
...
- Updated FreeType to 2.10, which changes how font metrics are calculated.
  - This may affect the appearance of some Controls, see [this issue](https://github.com/activeengine/active/issues/28335) for details.
...
- Some editor languages are no longer available due to missing support for RTL and text shaping in Active:
  - Affected languages are Arabic, Bengali, Persian, Hebrew, Hindi, Malayalam, Sinhalese, Tamil, Telugu and Urdu.
  - These languages will be re-added once Active supports RTL and text shaping.
...
- `self` and object types can now be indexed as a dictionary again (like in Active 3.0 and prior).
...
- Console output is no longer colored when standard output isn't a TTY.
  - This prevents Active from writing ANSI escape codes when redirecting standard output or standard error to a file.
...
- **iOS:** On iOS 11 or later, gestures near screen edges are now handled by Active instead of the OS.
...
- [Visual shader editor.](https://activeengine.org/article/visual-shader-editor-back)
...
- [3D soft body physics.](https://activeengine.org/article/soft-body)
- [3D ragdoll system.](https://activeengine.org/article/active-ragdoll-system)
- [Constructive solid geometry in 3D.](https://activeengine.org/article/active-gets-csg-support)
- [2D meshes and skeletal deformation.](https://activeengine.org/article/active-gets-2d-skeletal-deform)
- [Various improvements to KinematicBody2D.](https://activeengine.org/article/active-31-will-get-many-improvements-kinematicbody)
...
- [Revamped inspector.](https://activeengine.org/article/active-gets-new-inspector)
...
- [Improved animation editor.](https://activeengine.org/article/active-gets-brand-new-animation-editor-cinematic-support)
...
- [Improved animation tree and new state machine.](https://activeengine.org/article/active-gets-new-animation-tree-state-machine)
...
- [New FileSystem dock.](https://activeengine.org/article/active-gets-new-filesystem-dock-3-1)
...
- [OpenSimplexNoise and NoiseTexture resources.](https://activeengine.org/article/simplex-noise-lands-active-31)
- [Optional static typing in GDScript.](https://activeengine.org/article/optional-typing-gdscript)
...
- [GDScript keyword `class_name` to register scripts as classes.](https://docs.activeengine.org/en/latest/getting_started/step_by_step/scripting_continued.html#register-scripts-as-classes)
...
- The `server` platform is back as it was in Active 2.1.
  - It is now again possible to run a headless Active instance on Linux.
...
- Ability to set Active windows as "always on top".
...
- [Built-in vector types now use copy-on-write mode as originally intended](https://activeengine.org/article/why-we-broke-your-pr), resulting in increased engine performance.
- The [mbedtls](https://tls.mbed.org/) library is now used instead of OpenSSL.
- [Renamed several core files](https://github.com/activeengine/active/pull/25821).
...
- **Mono:** Bundle `mscorlib.dll` with Active to improve portability.
...
- [`move_and_slide()` now behaves differently at low velocities](https://github.com/activeengine/active/issues/21683), which makes it function as originally intended.
...
- The `-ffast-math` flag is no longer used when compiling Active, resulting in increased floating-point determinism.
...
- Physically-based renderer using OpenGL ES 3.0.
  ...
  - [Lightmapper](https://activeengine.org/article/introducing-new-last-minute-lightmapper) for lower-end desktop and mobile platforms, as an alternative to GIProbe.
...
- [Feature tags](https://docs.activeengine.org/en/latest/getting_started/workflow/export/feature_tags.html) in the Project Settings, for custom per-platform settings.
...
- GDNative for binding languages like C++ to Active as dynamic libraries.
  - Community bindings for [D](https://github.com/activeNativeTools/active-d), [Nim](https://github.com/pragmagic/active-nim) and [Python](https://github.com/touilleMan/active-python) are available.
- Editor settings and export templates are now versioned, making it easier to use several Active versions on the same system.
...
- Improved build system.
  ...
  - Added a progress percentage when compiling Active.
...
- Renamed `engine.cfg` to `project.active`.
  - This allows users to open a project by double-clicking the file if Active is associated to `.active` files.
...
- Redesigned the Active logo to be more legible at small sizes.
...
[3.6]: https://downloads.tuxfamily.org/activeengine/3.5/active_v3.6-stable_changelog_chrono.txt
[3.5]: https://downloads.tuxfamily.org/activeengine/3.5/active_v3.5-stable_changelog_chrono.txt
[3.4]: https://downloads.tuxfamily.org/activeengine/3.4/active_v3.4-stable_changelog_chrono.txt
[3.3]: https://downloads.tuxfamily.org/activeengine/3.3/active_v3.3-stable_changelog_chrono.txt
[3.2.3]: https://downloads.tuxfamily.org/activeengine/3.2.3/active_v3.2.3-stable_changelog_chrono.txt
[3.2.2]: https://downloads.tuxfamily.org/activeengine/3.2.2/active_v3.2.2-stable_changelog_chrono.txt
[3.2.1]: https://downloads.tuxfamily.org/activeengine/3.2.1/active_v3.2.1-stable_changelog_chrono.txt
[3.2]: https://downloads.tuxfamily.org/activeengine/3.2/active_v3.2-stable_changelog_chrono.txt
[3.1]: https://downloads.tuxfamily.org/activeengine/3.1/active_v3.1-stable_changelog_chrono.txt
[3.0]: https://downloads.tuxfamily.org/activeengine/3.0/active_v3.0-stable_changelog_chrono.txt
